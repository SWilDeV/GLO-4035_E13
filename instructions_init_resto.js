...
db.resto.insert({
  ...
  properties: {
    business_id: 127,
    name: "LES ENTREPRISES ALJO",
    address: "12515   Boulevard Rodolphe-Forget ",
    city: "Montréal",
    state: "Québec, Canada",
    type: "Distributrice automatique",
    statut: "Ouvert",
    date_statut: "20031123",
    latitude: "45.650661",
    longitude: "-73.580264",
    x: 298544.13,
    y: 5056754.99,
  ...
  geometry: {
    type: "Point",
    coordinates: [-73.580263608359701, 45.650660588882545],
  },
});
...
db.resto.count({
  geometry: {
    $near: {
      $geometry: { type: "Point", coordinates: [-73.561084, 45.515297] },
      $maxDistance: 1000,
    },
  },
});
db.resto
  .find({
    geometry: {
      $nearSphere: {
        $geometry: { type: "Point", coordinates: depart_parcours.coordinates },
        $maxDistance: 1000,
      },
    },
  })
